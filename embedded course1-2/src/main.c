...
/**
 * @file main.c
 * @brief Main entry point to the final assessment. Modified from C1M2 Assessment. 
 *
 ...
 * @author Alex Fosdick
 * @date April 1 2017
 * @modified by Jordan Tapia Nov 27 2020
 *
 */
#include "course1.h"
...
int main(){
/* Compile time switch -DCOURSE1 to call course1()*/
	#ifdef COURSE1
...
/* Comment out remaining code from C1M2
